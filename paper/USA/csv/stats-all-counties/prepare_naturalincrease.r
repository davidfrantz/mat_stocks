...
# plot county
#data %>% filter(FIPS == "51019") %>% select(starts_with("RNATURALINC")) %>% unlist() %>% plot(1980:2019, .)
...
write.csv(data, "paper/USA/csv/stats-all-counties/counties_naturalincrease.csv")
